...
int main()
{
    ...
    if(s[0]==')' or s[0]=='}' or s[0]==']' or s[0]=='>') ci;
    else if(n%2) ci;
    else
    {
        ll op=0,cl=0;
        for(i=0;i<n;i++)
        {
            if(s[i]=='(' or s[i]=='{' or s[i]=='[' or s[i]=='<') op++;
            else if(s[i]==')' or s[i]=='}' or s[i]==']' or s[i]=='>') cl++;
        }
        ...
        else
        {
            ...
            for(i=0;i<n;i++)
            {
                if(s[i]=='(' or s[i]=='{' or s[i]=='[' or s[i]=='<') st.push(s[i]);

                if( (s[i]==')' or s[i]=='}' or s[i]==']' or s[i]=='>') )
                {
                    if(st.empty()) {ci;return 0;}

                    char opn=st.top();
                    if(opn=='(' and s[i]!=')') ans++;
                    else if(opn=='{' and s[i]!='}') ans++;
                    else if(opn=='[' and s[i]!=']') ans++;
                    else if(opn=='<' and s[i]!='>') ans++;
