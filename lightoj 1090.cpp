...
ll  no_of_zero_in_factorial(ll  n,ll num) ///mumber of num in n!
{
    ll  cnt=0;
    while(n>0)
    {
...
ll  no_of_zero(ll  n,ll num) ///mumber of num in n
{
    ll  cnt=0;
...
int main()
{
   ...
   ll a2=no_of_zero_in_factorial(n,2);  ///for n!
   ll a5=no_of_zero_in_factorial(n,5);

   ll b2=no_of_zero_in_factorial(r,2);  ///for r!
   ll b5=no_of_zero_in_factorial(r,5);

   ll c2=no_of_zero_in_factorial(n-r,2);  ///for (n-r)!
   ll c5=no_of_zero_in_factorial(n-r,5);

   two=a2-b2-c2+(no_of_zero(p,2)*q);
   five=a5-b5-c5+(no_of_zero(p,5)*q);
